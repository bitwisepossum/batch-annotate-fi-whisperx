...
def transcribe_file(audio_path, output_dir, model, align_model, prompt, device, threads):
    # whisperx cli command with all the settings
    cmd = [
        'whisperx',
        str(audio_path),
        '--model', model,
...
def main():
    ...
    parser.add_argument(
        '--align-model',
        default='Finnish-NLP/wav2vec2-xlsr-1b-finnish-lm-v2',
        help='Finnish alignment model (default: Finnish-NLP/wav2vec2-xlsr-1b-finnish-lm-v2)'
    )
